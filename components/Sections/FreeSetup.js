    ...
    <section className="px:15 py:30 py:100@md bg:fade-8 color:white ">
      <div className="max-w:md mx:auto grid-cols:1 gap:30 gap:15@md grid-cols:2@md ai:center t:center t:left@md">
        ...
        <div className="t:right@md">
          <a
            href="https://client.n2hosting.com/index.php?fuse=support&controller=ticket&view=submitticket"
            className="inline-block px:30 px:60@md py:12 py:24@md f:16 f:20@md f:bold bg:pink-50 bg:pink-30:hover color:white r:30 r:60@md"
          >
            Contact Us
          </a>
        </div>
